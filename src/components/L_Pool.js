...
// Material
import { Box, Button, Select, Typography, MenuItem, Stack, TextField, Input, Grid, InputAdornment } from "@mui/material";
...
export function L_pool() {
    ...
    const checkPair = async () => {
        ...
        if (accounts.length !== 0) {
            ...
            try {
                const factory_contract = new ethers.Contract(factory_address, factory_abi, signer);
