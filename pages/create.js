            ...
            <CardWrapper>
                ...
                >
                    <CardOverlay onClick={() => fileRef.current.click()}>
                        <IconButton aria-label="close" onClick={(e) => handleResetFile(e)} sx={fileUrl ? { position: "absolute", right: "1vw", top: "1vh" } : { display: "none" }}>
                ...
                <Stack>
                    <LoadingButton loading={loading} loadingPosition="start" startIcon={<SendIcon />} onClick={uploadfile}>
                        Upload
                    </LoadingButton>
                </Stack>
        ...
        <Page title="Create - NFT">
            <Container maxWidth="md" sx={{ marginBottom: "3vh" }}>
                ...
                <Stack spacing={2} marginBottom={3} marginTop={3} direction="row">
                    ...
                    <Button sx={{ padding: 1, width: "35%" }} onClick={() => listNFT(tokenid)} variant="contained">
                        List Token
                    </Button>
                </Stack>
            </Container>
