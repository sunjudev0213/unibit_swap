...
// Material
import { Box, Container, styled, Toolbar, Button, TextField, Stack, Typography, Grid, Link, Input } from "@mui/material";
            ...
            <Stack justifyContent="center" display="flex">
                ...
                <Stack sx={{ border: "1px solid rgb(175, 175, 175)" }}>
                    <Grid
                        ...
                        onClick={() => {
                            setEth_status1(!eth_status1);
                        }}
                    >
                        <Grid item xs={12} md={3}>
                            <Stack direction="row" alignItems="center" justifyContent="center" display="flex">
                                <Box display="flex" alignItems="center" textAlign="center" sx={{ mr: 1 }}>
                        ...
                        >
                            ...
                            <Grid item xs={12} md={4}>
                                <Box
                                    ...
                                    sx={{
                                        alignItems: "center",
                                        border: "2px solid rgb(196, 196, 151)",
                                        borderRadius: "10px"
                                    }}
                                >
                                        ...
                                        <Box sx={{ width: "85%", marginBottom: "10px" }}>
                                            ...
                                            <div style={{ marginTop: "25px" }}>
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        approveHandler(LP_token1, farm1_address);
                                                    }}
                                                >
                                                    <h3>Enable</h3>
                                                </Button>
                                        ...
                                        <Box sx={{ width: "85%", marginBottom: "10px" }}>
                                            ...
                                            <Box display="flex" justifyContent="space-between" alignItems="center">
                                                <Button
                                                    ...
                                                    variant="outlined"
                                                    onClick={() => {
                                                        stakeHandler(farm1_address, amount_eth);
                                                    }}
                                                >
                                                    <h3>Stake</h3>
                                                </Button>
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        unstakeHandler(farm1_address, amount_eth);
                                                    }}
                                                >
                                                    <h3>Unstake</h3>
                                                </Button>
                                        ...
                                        <Box sx={{ width: "85%", marginBottom: "10px" }}>
                                            ...
                                            <div style={{ marginTop: "25px" }}>
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        approveHandler(LP_token1, farm2_address);
                                                    }}
                                                >
                                                    <h3>Enable</h3>
                                                </Button>
                                        ...
                                        <Box sx={{ width: "85%", marginBottom: "10px" }}>
                                            ...
                                            <Box display="flex" justifyContent="space-between" alignItems="center">
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        stakeHandler(farm2_address, amount_usdc);
                                                    }}
                                                >
                                                    <h3>Stake</h3>
                                                </Button>
                                                <Button
                                                    ...
                                                    variant="outlined"
                                                    onClick={() => {
                                                        unstakeHandler(farm2_address, amount_usdc);
                                                    }}
                                                >
                                                    <h3>Unstake</h3>
                                                </Button>
                                        ...
                                        <Box sx={{ width: "85%", marginBottom: "10px" }}>
                                            ...
                                            <div style={{ marginTop: "25px" }}>
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        approveHandler(LP_token2, farm3_address);
                                                    }}
                                                >
                                                    <h3>Enable</h3>
                                                </Button>
                                        ...
                                        <Box sx={{ width: "85%", marginBottom: "10px" }}>
                                            ...
                                            <Box display="flex" justifyContent="space-between" alignItems="center">
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        stakeHandler(farm3_address, amount_blo);
                                                    }}
                                                >
                                                    <h3>Stake</h3>
                                                </Button>
                                                <Button
                                                    ...
                                                    variant="outlined"
                                                    onClick={() => {
                                                        unstakeHandler(farm3_address, amount_blo);
                                                    }}
                                                >
                                                    <h3>Unstake</h3>
                                                </Button>
