...
// Material
import { Box, Container, styled, Toolbar, Button, Select, Typography, MenuItem, Stack, TextField, Input, Grid } from "@mui/material";
        ...
        return (
            <Stack alignItems="center" spacing={3} display="flex" justifyContent="center" sx={{ padding: { xs: "5px 0px", md: "15px 15px" } }}>
                ...
                <Box display="flex" alignItems="center" sx={{ width: "60%" }}>
                    <Button fullWidth sx={{ color: "black", background: "#F8D20F", mt: 3 }} onClick={() => {}}>
                        Get Reward
                    </Button>
                </Box>
            </Stack>
        ...
        return (
            <Stack alignItems="center" spacing={3} display="flex" sx={{ padding: { xs: "5px 0px", md: "15px 15px" } }}>
                ...
                <Box display="flex" alignItems="center" sx={{ width: "60%" }}>
                    <Button
                        fullWidth
                        sx={{ color: "black", background: "#F8D20F", mt: 3 }}
                        onClick={() => {
    ...
    return (
        <Box>
            ...
            <Stack justifyContent="center" alignItems="center" display="flex">
                ...
                >
                    {display === 1 && <Box>{noneligibillity()}</Box>}

                    {display === 2 && <Box>{eligibillity()}</Box>}
                    ...
                    {display === 0 && (
                        <Stack alignItems="center" justifyContent="center" spacing={3} display="flex" sx={{ padding: { xs: "5px 0px", md: "15px 15px" } }}>
                            ...
                            <Box display="flex" alignItems="center" sx={{ width: "60%" }}>
                                <Button fullWidth sx={{ color: "black", background: "#F8D20F", mt: 3 }} onClick={handleClickEligibility}>
                                    Check Eligibility
                                </Button>
                            </Box>
                        </Stack>
